...
mixin _$TemplateQuestion {
 ...
 String get body; String get type; int get points; List<TemplateOption> get options;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TemplateQuestion&&(identical(other.body, body) || other.body == body)&&(identical(other.type, type) || other.type == type)&&(identical(other.points, points) || other.points == points)&&const DeepCollectionEquality().equals(other.options, options));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,body,type,points,const DeepCollectionEquality().hash(options));

@override
String toString() {
  return 'TemplateQuestion(body: $body, type: $type, points: $points, options: $options)';
}
...
@useResult
$Res call({
 String body, String type, int points, List<TemplateOption> options
});
...
/// Create a copy of TemplateQuestion
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? body = null,Object? type = null,Object? points = null,Object? options = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String body,  String type,  int points,  List<TemplateOption> options)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TemplateQuestion() when $default != null:
return $default(_that.body,_that.type,_that.points,_that.options);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String body,  String type,  int points,  List<TemplateOption> options)  $default,) {final _that = this;
switch (_that) {
case _TemplateQuestion():
return $default(_that.body,_that.type,_that.points,_that.options);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String body,  String type,  int points,  List<TemplateOption> options)?  $default,) {final _that = this;
switch (_that) {
case _TemplateQuestion() when $default != null:
return $default(_that.body,_that.type,_that.points,_that.options);case _:
  return null;
...
class _TemplateQuestion implements TemplateQuestion {
  const _TemplateQuestion({required this.body, required this.type, required this.points, required final  List<TemplateOption> options}): _options = options;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TemplateQuestion&&(identical(other.body, body) || other.body == body)&&(identical(other.type, type) || other.type == type)&&(identical(other.points, points) || other.points == points)&&const DeepCollectionEquality().equals(other._options, _options));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,body,type,points,const DeepCollectionEquality().hash(_options));
...
/// Create a copy of TemplateQuestion
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? body = null,Object? type = null,Object? points = null,Object? options = null,}) {
