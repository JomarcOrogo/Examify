...
@JsonKey(name: 'calculated_grade') double get calculatedGrade;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GradebookEntry&&(identical(other.id, id) || other.id == id)&&(identical(other.studentId, studentId) || other.studentId == studentId)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.section, section) || other.section == section)&&const DeepCollectionEquality().equals(other.scores, scores)&&(identical(other.calculatedGrade, calculatedGrade) || other.calculatedGrade == calculatedGrade));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,studentId,name,email,section,const DeepCollectionEquality().hash(scores),calculatedGrade);

@override
String toString() {
  return 'GradebookEntry(id: $id, studentId: $studentId, name: $name, email: $email, section: $section, scores: $scores, calculatedGrade: $calculatedGrade)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'student_id') String? studentId, String name, String? email, String? section, Map<String, double?> scores,@JsonKey(name: 'calculated_grade') double calculatedGrade
});
...
/// Create a copy of GradebookEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? studentId = freezed,Object? name = null,Object? email = freezed,Object? section = freezed,Object? scores = null,Object? calculatedGrade = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'student_id')  String? studentId,  String name,  String? email,  String? section,  Map<String, double?> scores, @JsonKey(name: 'calculated_grade')  double calculatedGrade)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GradebookEntry() when $default != null:
return $default(_that.id,_that.studentId,_that.name,_that.email,_that.section,_that.scores,_that.calculatedGrade);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'student_id')  String? studentId,  String name,  String? email,  String? section,  Map<String, double?> scores, @JsonKey(name: 'calculated_grade')  double calculatedGrade)  $default,) {final _that = this;
switch (_that) {
case _GradebookEntry():
return $default(_that.id,_that.studentId,_that.name,_that.email,_that.section,_that.scores,_that.calculatedGrade);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'student_id')  String? studentId,  String name,  String? email,  String? section,  Map<String, double?> scores, @JsonKey(name: 'calculated_grade')  double calculatedGrade)?  $default,) {final _that = this;
switch (_that) {
case _GradebookEntry() when $default != null:
return $default(_that.id,_that.studentId,_that.name,_that.email,_that.section,_that.scores,_that.calculatedGrade);case _:
  return null;
...
class _GradebookEntry implements GradebookEntry {
  const _GradebookEntry({required this.id, @JsonKey(name: 'student_id') this.studentId, required this.name, this.email, this.section, required final  Map<String, double?> scores, @JsonKey(name: 'calculated_grade') required this.calculatedGrade}): _scores = scores;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,studentId,name,email,section,const DeepCollectionEquality().hash(_scores),calculatedGrade);
...
/// Create a copy of GradebookEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? studentId = freezed,Object? name = null,Object? email = freezed,Object? section = freezed,Object? scores = null,Object? calculatedGrade = null,}) {
